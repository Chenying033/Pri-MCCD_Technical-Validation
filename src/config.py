...
def get_args():
    ...
    parser.add_argument('--use_transformer_fusion', action='store_true',
                        help='whether to use Transformer for multimodal fusion')
    parser.add_argument('--use_attention_fusion', action='store_true',
                        help='whether to use Attention for multimodal fusion')
    ...
    parser.add_argument('--use_visual', type=str2bool, default=True,
                        help='Whether to use visual modality')
    parser.add_argument('--use_audio', type=str2bool, default=True,
                        help='Whether to use acoustic modality')
...
def get_config(dataset='mosi', mode='train', batch_size=32,
               visual_encoder_type='rnn',
               acoustic_encoder_type='rnn',
    ...
    config.visual_encoder_type = visual_encoder_type
    config.acoustic_encoder_type = acoustic_encoder_type
    config.use_transformer_fusion = use_transformer_fusion
    config.save_name = save_name

    # 🔧 新增模态控制项
    config.use_visual = use_visual
    config.use_audio = use_audio
