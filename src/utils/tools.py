...
def save_model(args, model, name=''):
    ...
    if not os.path.exists('/data1/cy/Multimodal-Infomax/pre_trained_models'):
        os.mkdir('/data1/cy/Multimodal-Infomax/pre_trained_models')
    torch.save(model.state_dict(), f'/data1/cy/Multimodal-Infomax/pre_trained_models/{name}.pt')
